...
2. Download the 0.122.0 version from the [Hugo GitHub](https://github.com/gohugoio/hugo/releases/tag/v0.122.0). **Specifically, we downloaded hugo_extended_0.122.0_darwin-universal.tar.gz**. Select the file that corresponds with your operating system. 

3. Extract the downloaded file and run 
